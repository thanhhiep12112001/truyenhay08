...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="pages">{{$tag}}</li>
        </ol>
    </nav>
    </div>
    <div class="container">
        <div style="margin-top: 30px">
            <h6 style="font-weight: bold">Bạn tìm kiếm với từ khóa là : {{$tag}}<i class="fa fa-star" aria-hidden="true"
